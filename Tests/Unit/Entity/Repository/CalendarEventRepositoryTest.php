...
class CalendarEventRepositoryTest extends OrmTestCase
{
    ...
    public function testGetUserEventListByTimeIntervalQueryBuilder()
    {
        ...
        $this->assertEquals(
            ...
            . ' COALESCE(status.internalId, \'none\') as invitationStatus,'
            ...
            . ' LEFT JOIN Oro\Bundle\EntityExtendBundle\Entity\EnumOption status '
            . 'WITH JSON_EXTRACT(relatedAttendee.serialized_data, \'status\') = status'
            . ' INNER JOIN e.calendar c'
            . ' LEFT JOIN Oro\Bundle\CalendarBundle\Entity\Recurrence r WITH (parent.id IS NOT NULL'
            . ' AND parent.recurrence = r.id) OR'
    ...
    public function testGetSystemEventListByTimeIntervalQueryBuilder()
    {
        ...
        $this->assertEquals(
            ...
            . ' LEFT JOIN e.parent parent LEFT JOIN Oro\Bundle\CalendarBundle\Entity\Recurrence r WITH'
