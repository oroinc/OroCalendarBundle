...
import template from 'tpl-loader!orocalendar/templates/calendar/event/recurrence/recurrence.html';
import originValuesTemplate
    from 'tpl-loader!orocalendar/templates/calendar/event/recurrence/recurrence-origin-values.html';
import BaseView from 'oroui/js/app/views/base/view';
import RecurrenceEndsView from 'orocalendar/js/calendar/event/recurrence/recurrence-ends-view';
import RecurrenceSummaryView from 'orocalendar/js/calendar/event/recurrence/recurrence-summary-view';
import RecurrenceDailyView from 'orocalendar/js/calendar/event/recurrence/recurrence-daily-view';
import RecurrenceWeeklyView from 'orocalendar/js/calendar/event/recurrence/recurrence-weekly-view';
import RecurrenceMonthlyView from 'orocalendar/js/calendar/event/recurrence/recurrence-monthly-view';
import RecurrenceYearlyView from 'orocalendar/js/calendar/event/recurrence/recurrence-yearly-view';
...
export default EventRecurrenceView;
