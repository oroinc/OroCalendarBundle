...
import EventModel from 'orocalendar/js/calendar/event/model';
import EventView from 'orocalendar/js/calendar/event/view';
import ConnectionView from 'orocalendar/js/calendar/connection/view';
import eventDecorator from 'orocalendar/js/calendar/event-decorator';
import ColorManager from 'orocalendar/js/calendar/color-manager';
...
import AttendeesPlugin from 'orocalendar/js/app/plugins/calendar/attendees-plugin';
import EventRecurrencePlugin from 'orocalendar/js/app/plugins/calendar/event-recurrence-plugin';
import persistentStorage from 'oroui/js/persistent-storage';
import Modal from 'oroui/js/modal';
import 'orocalendar/js/fullcalendar';
import 'fullcalendar';
